...
class RouterStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SendPaymentV2 = channel.unary_stream(
                ...
                response_deserializer=lndgrpc_dot_compiled_dot_lightning__pb2.Payment.FromString,
                )
        ...
        self.TrackPayments = channel.unary_stream(
                ...
                request_serializer=lndgrpc_dot_compiled_dot_router__pb2.TrackPaymentsRequest.SerializeToString,
                response_deserializer=lndgrpc_dot_compiled_dot_lightning__pb2.Payment.FromString,
                )
        ...
        self.SendToRouteV2 = channel.unary_unary(
                ...
                request_serializer=lndgrpc_dot_compiled_dot_router__pb2.SendToRouteRequest.SerializeToString,
                response_deserializer=lndgrpc_dot_compiled_dot_lightning__pb2.HTLCAttempt.FromString,
                )
...
def add_RouterServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'SendPaymentV2': grpc.unary_stream_rpc_method_handler(
                    ...
                    response_serializer=lndgrpc_dot_compiled_dot_lightning__pb2.Payment.SerializeToString,
            ),
            ...
            'TrackPayments': grpc.unary_stream_rpc_method_handler(
                    ...
                    request_deserializer=lndgrpc_dot_compiled_dot_router__pb2.TrackPaymentsRequest.FromString,
                    response_serializer=lndgrpc_dot_compiled_dot_lightning__pb2.Payment.SerializeToString,
            ),
            ...
            'SendToRouteV2': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=lndgrpc_dot_compiled_dot_router__pb2.SendToRouteRequest.FromString,
                    response_serializer=lndgrpc_dot_compiled_dot_lightning__pb2.HTLCAttempt.SerializeToString,
            ),
...
class Router(object):
    ...
    def SendPaymentV2(request,
        ...
        return grpc.experimental.unary_stream(request, target, '/routerrpc.Router/SendPaymentV2',
            ...
            lndgrpc_dot_compiled_dot_lightning__pb2.Payment.FromString,
    ...
    def TrackPayments(request,
        ...
        return grpc.experimental.unary_stream(request, target, '/routerrpc.Router/TrackPayments',
            lndgrpc_dot_compiled_dot_router__pb2.TrackPaymentsRequest.SerializeToString,
            lndgrpc_dot_compiled_dot_lightning__pb2.Payment.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def SendToRouteV2(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/routerrpc.Router/SendToRouteV2',
            lndgrpc_dot_compiled_dot_router__pb2.SendToRouteRequest.SerializeToString,
            lndgrpc_dot_compiled_dot_lightning__pb2.HTLCAttempt.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
