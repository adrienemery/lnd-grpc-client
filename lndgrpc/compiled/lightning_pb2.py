...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='lndgrpc/compiled/lightning.proto',
  package='lnrpc',
  syntax='proto3',
...
_WALLETBALANCERESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='account_balance', full_name='lnrpc.WalletBalanceResponse.account_balance', index=4,
      number=4, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LIGHTNING = _descriptor.ServiceDescriptor(
  ...
  serialized_options=None,
  create_key=_descriptor._internal_create_key,
  serialized_start=29123,
  serialized_end=33932,
  methods=[
